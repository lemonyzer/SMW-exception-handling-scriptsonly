...
//								translatedTile.iRow = currentRawTilesetTile.iRow;
								...
								// in diesem ELSE darf translatedTile.iTilesetID 0 bis eingeschlossen mapSO.GetMaxTilesetID laufen, wenn ein anderer wert drin steht dann setzte TilesetID von aktuellem Tile auf das Tileset das als erstes in Map angegebenen wurde

								if(translatedTile.iTilesetID > mapSO.GetMaxTilesetID())
								{
