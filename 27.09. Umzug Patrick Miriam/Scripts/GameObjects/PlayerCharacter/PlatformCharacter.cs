...
//			}
	...
	public void CollectingItem(ItemScript collectingItem)
	{
		...
		collectingItem.GetItem().Collecting(collectingItem.gameObject, this);
	}
	...
	public void CollectingItem(GameObject goItem)
	{
		...
		Item currentItem = goItem.GetComponent<ItemScript>().GetItem();		// muss genaues Script erhalten <-- Item is wrong
