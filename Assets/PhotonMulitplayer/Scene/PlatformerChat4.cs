...
public class PlatformerChat4 : Photon.MonoBehaviour
{
    ...
    private List<PlatformerChatEntry> chatEntries = new List<PlatformerChatEntry>();
    public class PlatformerChatEntry
    {
        public string name = "";
        public string text = "";
    }
      ...
      public void SetShowChatWindow(bool show)
    {
        showChat = show;
        inputField = "";      
        chatEntries = new List<PlatformerChatEntry>();
    }
    ...
    void GlobalChatWindow(int id)
    {
        ...
        foreach (PlatformerChatEntry entry in chatEntries as List<PlatformerChatEntry>)
        {
    ...
    {
        PlatformerChatEntry entry = new PlatformerChatEntry();
        entry.name = name;
        entry.text = msg;
