...
public class PushSkriptPhoton : MonoBehaviour {
	...
	PlayerControllerPhoton myPlayerController;
	PlayerControllerPhoton otherPlayerController;
	...
	void Start () {
		...
		myPlayerController = GetComponent<PlayerControllerPhoton>();
		if(myPlayerController == null)
			Debug.LogError(myCharacter.name + " hat kein PlayerControllerPhoton");
		else
			isKI = false;
